...
create_plot('evaluation/data_ds/ds_barc_finetuned_output_combined_results.csv', 
           ax1, 'Finetuned Model Performance')

create_plot('evaluation/data_ds/ds_barc_finetuned_output_combined_results_oracle.csv', 
           ax2, 'Finetuned Oracle Model Performance')



create_plot('evaluation/data_ds/ds_barc_non_finetuned_output_combined_results.csv', 
           ax3, 'Non-Finetuned Model Performance')

create_plot('evaluation/data_ds/ds_barc_non_finetuned_output_combined_results_oracle.csv', 
           ax4, 'Non-Finetuned Oracle Model Performance')



# Add a super title
fig.suptitle('Model Performance Comparison Across Training Iterations', fontsize=16, y=1.05)

# Adjust layout and save
plt.tight_layout()
plt.savefig('evaluation/plots_ds/training_progression_comparison_ds_barc.png', 
