...
def create_plots(base_path, output_name):
    ...
    print(f'Saving plot to evaluation/plots/{output_name}_metrics.png')
...
def __main__(): 
    ...
    parser.add_argument("--base_path", type=str, default="experiments_submission_files/experiments_thesis_epoch_scaling_8_barc/epoch_scaling_barc_non_finetuned_output")
