...
ttt_experiment_name="baseline_1000_permute_2_20k"

ttt_log_folder="experiments_thesis/baseline_1000_20k/${ttt_experiment_name}/logs"
ttt_folder="experiments_thesis/baseline_1000_20k/${ttt_experiment_name}/adapters_json"
