...
EXPERIMENT_FOLDER="/hkfs/work/workspace/scratch/tum_ind3695-arc-workspace/experiments_thesis_dataset_scaling/1000_permute_3-4_20k_double"

SOURCE_FILE="${EXPERIMENT_FOLDER}/adapters_json/00576224/adapter_config.json"
