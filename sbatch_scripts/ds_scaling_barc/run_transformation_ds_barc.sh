...
lora_config_file=configs/ttt/8.1B_lora_single_device.yaml
...
ttt_experiment_folder="${scratch_dir}/experiments_thesis_ds_barc"
experiment_name="ds_debug"
ttt_folder="${ttt_experiment_folder}/${experiment_name}/adapters_json"
mkdir -p $ttt_folder



python debug_transformations_barc.py --lora_config=$lora_config_file \
